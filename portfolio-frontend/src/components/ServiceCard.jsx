  ...
  return (
    <div className="bg-[#f4f1ea] rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full border border-[#d6c7b8]">
      ...
      <div className="p-8 flex flex-col flex-grow">
        <h3 className="text-2xl font-serif italic text-[#5c2d2d] mb-2">
          {title}
        </h3>
        ...
        <button
          onClick={onBook}
          className="w-full py-3 border border-[#5c2d2d] text-[#5c2d2d] uppercase text-xs tracking-widest font-bold rounded-lg hover:bg-[#5c2d2d] hover:text-white transition-all duration-300"
        >
